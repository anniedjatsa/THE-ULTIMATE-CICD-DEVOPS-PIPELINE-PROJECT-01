...
resource "aws_security_group" "jenkins_sg" {
  ...
  # Custom TCP Range for additional services
  ingress {
  ...
  # Custom TCP Range for Kubernetes NodePort
  ingress {
...
# Security Group for Nexus and SonarQube
resource "aws_security_group" "tools_sg" {
  name        = "${var.project_name}-tools-sg"
  description = "Security group for Nexus and SonarQube"
